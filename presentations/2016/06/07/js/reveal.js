...
console.log(window.location.hash, 'left');
		// Reverse for RTL
		if( config.rtl ) {
...
console.log(window.location.hash, 'right');
		// Reverse for RTL
		if( config.rtl ) {
	...
	function navigateUp() {
console.log(window.location.hash, 'up');
...
console.log(window.location.hash, 'down');
...
console.log(window.location.hash, 'prev');
		// Prioritize revealing fragments
...
console.log(window.location.hash, 'next');
		// Prioritize revealing fragments
