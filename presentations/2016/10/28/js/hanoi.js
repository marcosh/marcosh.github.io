...
var _marcosh$elm_hanoi$Hanoi$disksPerPeg = _marcosh$elm_hanoi$Hanoi$disksPerPegNumber(1);
var _marcosh$elm_hanoi$Hanoi$ThirdPeg = {ctor: 'ThirdPeg'};
var _marcosh$elm_hanoi$Hanoi$SecondPeg = {ctor: 'SecondPeg'};
var _marcosh$elm_hanoi$Hanoi$FirstPeg = {ctor: 'FirstPeg'};
var _marcosh$elm_hanoi$Hanoi$init = A2(_elm_lang$core$List$repeat, 3, _marcosh$elm_hanoi$Hanoi$FirstPeg);
var _marcosh$elm_hanoi$Hanoi$disposition = function (model) {
	return {
		ctor: '_Tuple3',
		_0: A2(_marcosh$elm_hanoi$Hanoi$disksPerPeg, model, _marcosh$elm_hanoi$Hanoi$FirstPeg),
		_1: A2(_marcosh$elm_hanoi$Hanoi$disksPerPeg, model, _marcosh$elm_hanoi$Hanoi$SecondPeg),
		_2: A2(_marcosh$elm_hanoi$Hanoi$disksPerPeg, model, _marcosh$elm_hanoi$Hanoi$ThirdPeg)
	};
};
var _marcosh$elm_hanoi$Hanoi$NoDiskOnPeg = {ctor: 'NoDiskOnPeg'};
var _marcosh$elm_hanoi$Hanoi$InvalidMove = {ctor: 'InvalidMove'};
var _marcosh$elm_hanoi$Hanoi$SamePeg = {ctor: 'SamePeg'};
var _marcosh$elm_hanoi$Hanoi$move = F3(
		...
		if (_elm_lang$core$Native_Utils.eq(from, to)) {
			...
			if (_p2.ctor === '::') {
				...
				return {
					...
					_0: _elm_lang$core$Native_List.fromArray(
						[]),
					_1: _elm_lang$core$Maybe$Just(_marcosh$elm_hanoi$Hanoi$NoDiskOnPeg)
				};
			}
		}
	});

var _marcosh$elm_hanoi$HanoiView$viewDisk = function (i) {
	return A2(
...
var _marcosh$elm_hanoi$HanoiView$pegToPosition = function (peg) {
	...
	switch (_p0.ctor) {
		...
		case 'Second':
			return _marcosh$elm_hanoi$Hanoi$SecondPeg;
		default:
			return _marcosh$elm_hanoi$Hanoi$ThirdPeg;
	}
};
var _marcosh$elm_hanoi$HanoiView$Model = F4(
	function (a, b, c, d) {
		return {status: a, from: b, to: c, message: d};
	});
var _marcosh$elm_hanoi$HanoiView$init = function () {
	var status = _marcosh$elm_hanoi$Hanoi$init;
	return A4(_marcosh$elm_hanoi$HanoiView$Model, status, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing);
}();
			...
			switch (_p2._0.ctor) {
				case 'SamePeg':
					return A4(
						...
						newStatus,
						_elm_lang$core$Maybe$Just(from),
						_elm_lang$core$Maybe$Just(to),
						_elm_lang$core$Maybe$Just('You can not move a disk to a peg where it already is'));
				case 'InvalidMove':
					return A4(
						_marcosh$elm_hanoi$HanoiView$Model,
						newStatus,
						_elm_lang$core$Maybe$Just(from),
						_elm_lang$core$Maybe$Just(to),
						_elm_lang$core$Maybe$Just('Invalid move'));
				default:
					return A4(
						_marcosh$elm_hanoi$HanoiView$Model,
						newStatus,
						_elm_lang$core$Maybe$Just(from),
						_elm_lang$core$Maybe$Just(to),
						_elm_lang$core$Maybe$Just('There is no disk in your starting peg'));
			}
		} else {
			return A4(_marcosh$elm_hanoi$HanoiView$Model, newStatus, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing);
		}
	});
	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			case 'From':
				return _elm_lang$core$Native_Utils.update(
					model,
					{from: _p3._0, message: _elm_lang$core$Maybe$Nothing});
			case 'To':
				return _elm_lang$core$Native_Utils.update(
					model,
					{to: _p3._0, message: _elm_lang$core$Maybe$Nothing});
			case 'Error':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
			...
			default:
				return A3(_marcosh$elm_hanoi$HanoiView$performMove, model.status, _p3._0, _p3._1);
		}
	});
var _marcosh$elm_hanoi$HanoiView$Third = {ctor: 'Third'};
var _marcosh$elm_hanoi$HanoiView$Second = {ctor: 'Second'};
var _marcosh$elm_hanoi$HanoiView$First = {ctor: 'First'};
...
var _marcosh$elm_hanoi$HanoiView$onSelect = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
...
var _marcosh$elm_hanoi$HanoiView$tryMove = function (model) {
	var _p5 = {ctor: '_Tuple2', _0: model.from, _1: model.to};
	if (_p5._0.ctor === 'Nothing') {
		...
		if (_p5._1.ctor === 'Nothing') {
			...
			return A2(_marcosh$elm_hanoi$HanoiView$Move, _p5._0._0, _p5._1._0);
		}
	}
};
...
var _marcosh$elm_hanoi$HanoiView$From = function (a) {
	return {ctor: 'From', _0: a};
};
var _marcosh$elm_hanoi$HanoiView$view = function (model) {
	var _p6 = _marcosh$elm_hanoi$Hanoi$disposition(model.status);
	var firstPeg = _p6._0;
	var secondPeg = _p6._1;
	var thirdPeg = _p6._2;
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_elm_lang$core$List$map, _marcosh$elm_hanoi$HanoiView$viewDisk, firstPeg))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_elm_lang$core$List$map, _marcosh$elm_hanoi$HanoiView$viewDisk, secondPeg))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_elm_lang$core$List$map, _marcosh$elm_hanoi$HanoiView$viewDisk, thirdPeg))
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('hanoi-controls')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
...
var _marcosh$elm_hanoi$Main$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _marcosh$elm_hanoi$HanoiView$init, update: _marcosh$elm_hanoi$HanoiView$update, view: _marcosh$elm_hanoi$HanoiView$view})
};

var _marcosh$elm_hanoi$WebsocketHanoiView$messageDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
		}),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'from', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'to', _elm_lang$core$Json_Decode$int));
var _marcosh$elm_hanoi$WebsocketHanoiView$viewDisk = function (i) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _marcosh$elm_hanoi$WebsocketHanoiView$pegToInt = function (peg) {
	var _p0 = peg;
	switch (_p0.ctor) {
		case 'First':
			return 1;
...
var _marcosh$elm_hanoi$WebsocketHanoiView$pegToPosition = function (peg) {
	var _p1 = peg;
	switch (_p1.ctor) {
		case 'First':
			return _marcosh$elm_hanoi$Hanoi$FirstPeg;
...
var _marcosh$elm_hanoi$WebsocketHanoiView$Model = F4(
	function (a, b, c, d) {
		return {status: a, from: b, to: c, message: d};
	});
var _marcosh$elm_hanoi$WebsocketHanoiView$init = function () {
	var status = _marcosh$elm_hanoi$Hanoi$init;
	return {
		ctor: '_Tuple2',
		_0: A4(_marcosh$elm_hanoi$WebsocketHanoiView$Model, status, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing),
		_1: _elm_lang$core$Platform_Cmd$none
	};
}();
var _marcosh$elm_hanoi$WebsocketHanoiView$performMove = F3(
	function (status, from, to) {
		var _p2 = A3(
			_marcosh$elm_hanoi$Hanoi$move,
			status,
			_marcosh$elm_hanoi$WebsocketHanoiView$pegToPosition(from),
			_marcosh$elm_hanoi$WebsocketHanoiView$pegToPosition(to));
		var newStatus = _p2._0;
		var maybeOutMsg = _p2._1;
		var _p3 = maybeOutMsg;
		if (_p3.ctor === 'Just') {
			switch (_p3._0.ctor) {
				case 'SamePeg':
					return A4(
						_marcosh$elm_hanoi$WebsocketHanoiView$Model,
						newStatus,
						_elm_lang$core$Maybe$Just(from),
						_elm_lang$core$Maybe$Just(to),
						_elm_lang$core$Maybe$Just('You can not move a disk to a peg where it already is'));
			...
			return A4(_marcosh$elm_hanoi$WebsocketHanoiView$Model, newStatus, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing);
		}
	});
var _marcosh$elm_hanoi$WebsocketHanoiView$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'From':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{from: _p4._0, message: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'To':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{to: _p4._0, message: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Error':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							message: _elm_lang$core$Maybe$Just(_p4._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RequestMove':
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_1: _elm_lang$core$Json_Encode$int(
									_marcosh$elm_hanoi$WebsocketHanoiView$pegToInt(_p4._0))
							},
								{
								ctor: '_Tuple2',
								_0: 'to',
								_1: _elm_lang$core$Json_Encode$int(
									_marcosh$elm_hanoi$WebsocketHanoiView$pegToInt(_p4._1))
							}
							])));
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$websocket$WebSocket$send, 'ws://localhost:8080', encodedJson)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: A3(_marcosh$elm_hanoi$WebsocketHanoiView$performMove, model.status, _p4._0, _p4._1),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _marcosh$elm_hanoi$WebsocketHanoiView$Third = {ctor: 'Third'};
var _marcosh$elm_hanoi$WebsocketHanoiView$Second = {ctor: 'Second'};
var _marcosh$elm_hanoi$WebsocketHanoiView$First = {ctor: 'First'};
var _marcosh$elm_hanoi$WebsocketHanoiView$intToMaybePeg = function (i) {
	var _p5 = i;
	switch (_p5) {
		case 1:
			return _elm_lang$core$Maybe$Just(_marcosh$elm_hanoi$WebsocketHanoiView$First);
		case 2:
			return _elm_lang$core$Maybe$Just(_marcosh$elm_hanoi$WebsocketHanoiView$Second);
		case 3:
			return _elm_lang$core$Maybe$Just(_marcosh$elm_hanoi$WebsocketHanoiView$Third);
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
var _marcosh$elm_hanoi$WebsocketHanoiView$targetSelectedIndex = A2(
	_elm_lang$core$Json_Decode$map,
	_marcosh$elm_hanoi$WebsocketHanoiView$intToMaybePeg,
	A2(
		_elm_lang$core$Json_Decode$at,
		_elm_lang$core$Native_List.fromArray(
			['target', 'selectedIndex']),
		_elm_lang$core$Json_Decode$int));
var _marcosh$elm_hanoi$WebsocketHanoiView$onSelect = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, msg, _marcosh$elm_hanoi$WebsocketHanoiView$targetSelectedIndex));
};
var _marcosh$elm_hanoi$WebsocketHanoiView$Move = F2(
	function (a, b) {
		return {ctor: 'Move', _0: a, _1: b};
	});
var _marcosh$elm_hanoi$WebsocketHanoiView$RequestMove = F2(
	function (a, b) {
		return {ctor: 'RequestMove', _0: a, _1: b};
	});
var _marcosh$elm_hanoi$WebsocketHanoiView$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _marcosh$elm_hanoi$WebsocketHanoiView$tryMove = function (model) {
	var _p6 = {ctor: '_Tuple2', _0: model.from, _1: model.to};
	if (_p6._0.ctor === 'Nothing') {
		return _marcosh$elm_hanoi$WebsocketHanoiView$Error('You didn\'t specify the starting peg');
	} else {
		if (_p6._1.ctor === 'Nothing') {
			return _marcosh$elm_hanoi$WebsocketHanoiView$Error('You didn\'t specify the ending peg');
		} else {
			return A2(_marcosh$elm_hanoi$WebsocketHanoiView$RequestMove, _p6._0._0, _p6._1._0);
		}
	}
};
var _marcosh$elm_hanoi$WebsocketHanoiView$subscriptionStringToMessage = function (message) {
	var result = A2(_elm_lang$core$Json_Decode$decodeString, _marcosh$elm_hanoi$WebsocketHanoiView$messageDecoder, message);
	var _p7 = result;
	if (_p7.ctor === 'Err') {
		return _marcosh$elm_hanoi$WebsocketHanoiView$Error(_p7._0);
	} else {
		var _p9 = _p7._0;
		var maybeSecond = _marcosh$elm_hanoi$WebsocketHanoiView$intToMaybePeg(
			_elm_lang$core$Basics$snd(_p9));
		var maybeFirst = _marcosh$elm_hanoi$WebsocketHanoiView$intToMaybePeg(
			_elm_lang$core$Basics$fst(_p9));
		var _p8 = {ctor: '_Tuple2', _0: maybeFirst, _1: maybeSecond};
		if (((_p8.ctor === '_Tuple2') && (_p8._0.ctor === 'Just')) && (_p8._1.ctor === 'Just')) {
			return A2(_marcosh$elm_hanoi$WebsocketHanoiView$Move, _p8._0._0, _p8._1._0);
		} else {
			return _marcosh$elm_hanoi$WebsocketHanoiView$Error('The received message does not represent a valid move');
		}
	}
};
var _marcosh$elm_hanoi$WebsocketHanoiView$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:8080', _marcosh$elm_hanoi$WebsocketHanoiView$subscriptionStringToMessage);
};
var _marcosh$elm_hanoi$WebsocketHanoiView$To = function (a) {
	return {ctor: 'To', _0: a};
};
var _marcosh$elm_hanoi$WebsocketHanoiView$From = function (a) {
	return {ctor: 'From', _0: a};
};
var _marcosh$elm_hanoi$WebsocketHanoiView$view = function (model) {
	var _p10 = _marcosh$elm_hanoi$Hanoi$disposition(model.status);
	var firstPeg = _p10._0;
	var secondPeg = _p10._1;
	var thirdPeg = _p10._2;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_elm_lang$core$List$map, _marcosh$elm_hanoi$WebsocketHanoiView$viewDisk, firstPeg))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_elm_lang$core$List$map, _marcosh$elm_hanoi$WebsocketHanoiView$viewDisk, secondPeg))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_elm_lang$core$List$map, _marcosh$elm_hanoi$WebsocketHanoiView$viewDisk, thirdPeg))
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_marcosh$elm_hanoi$WebsocketHanoiView$onSelect(_marcosh$elm_hanoi$WebsocketHanoiView$From)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_Utils.eq(
													model.from,
													_elm_lang$core$Maybe$Just(_marcosh$elm_hanoi$WebsocketHanoiView$First)))
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('First')
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_Utils.eq(
													model.from,
													_elm_lang$core$Maybe$Just(_marcosh$elm_hanoi$WebsocketHanoiView$Second)))
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Second')
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_Utils.eq(
													model.from,
													_elm_lang$core$Maybe$Just(_marcosh$elm_hanoi$WebsocketHanoiView$Third)))
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Third')
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_marcosh$elm_hanoi$WebsocketHanoiView$onSelect(_marcosh$elm_hanoi$WebsocketHanoiView$To)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(
								_marcosh$elm_hanoi$WebsocketHanoiView$tryMove(model))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Move')
...
var _marcosh$elm_hanoi$WebsocketMain$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _marcosh$elm_hanoi$WebsocketHanoiView$init, update: _marcosh$elm_hanoi$WebsocketHanoiView$update, view: _marcosh$elm_hanoi$WebsocketHanoiView$view, subscriptions: _marcosh$elm_hanoi$WebsocketHanoiView$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _marcosh$elm_hanoi$Main$main === 'undefined' ? null : _marcosh$elm_hanoi$Main$main);
Elm['WebsocketMain'] = Elm['WebsocketMain'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['WebsocketMain'], 'WebsocketMain', typeof _marcosh$elm_hanoi$WebsocketMain$main === 'undefined' ? null : _marcosh$elm_hanoi$WebsocketMain$main);
