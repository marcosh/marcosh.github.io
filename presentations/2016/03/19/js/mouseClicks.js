...
Elm.MouseClicks = Elm.MouseClicks || {};
Elm.MouseClicks.make = function (_elm) {
   "use strict";
   _elm.MouseClicks = _elm.MouseClicks || {};
   if (_elm.MouseClicks.values) return _elm.MouseClicks.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   var _op = {};
   var countClick = A3($Signal.foldp,F2(function (clk,count) {    return count + 1;}),0,$Mouse.clicks);
   var containerShow = function (signal) {    return A4($Graphics$Element.container,1200,200,$Graphics$Element.middle,$Graphics$Element.show(signal));};
   var main = A2($Signal.map,containerShow,countClick);
   return _elm.MouseClicks.values = {_op: _op,containerShow: containerShow,main: main,countClick: countClick};
};
