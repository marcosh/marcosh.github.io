...
Elm.Component.Note.make = function (_elm) {
   ...
   var toElement = function (str) {
      var textElement = $Graphics$Element.justified(A2($Text.height,
      30,
      A2($Text.typeface,_U.list(["Source Code Pro","consolas","inconsolata","monospace"]),$Text.fromString(str))));
...
Elm.Component.Sandbox.make = function (_elm) {
   ...
   var signalValue = F2(function (color,value) {
      var display = function (value) {
         ...
         $Config$Size.seriesValueWidth,
         $Graphics$Element.justified(A2($Text.height,40,A2($Text.color,color,$Text.fromString($Basics.toString(value)))))));
      };
   ...
   var signalLabel = function (name) {
      ...
      30,
      A2($Text.typeface,_U.list(["Source Code Pro","consolas","inconsolata","monospace"]),$Text.fromString(name))))));
...
Elm.Page.SignalMerge.make = function (_elm) {
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var clickPressTickNote = $Component$Note.signalNote("mergeMany [ clicks, presses, ticks ]");
   ...
   _U.list([clicksActionElement,keyPressesElement,tickActionElement,clickPressTickNote,clickPressTickElement]));
   return _elm.Page.SignalMerge.values = {_op: _op,view: view};
};
Elm.SignalMerge = Elm.SignalMerge || {};
Elm.SignalMerge.make = function (_elm) {
   "use strict";
   _elm.SignalMerge = _elm.SignalMerge || {};
   if (_elm.SignalMerge.values) return _elm.SignalMerge.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var containerShow = function (element) {    return A4($Graphics$Element.container,1200,550,$Graphics$Element.middle,element);};
   var main = A2($Signal.map,containerShow,$Page$SignalMerge.view);
   return _elm.SignalMerge.values = {_op: _op,containerShow: containerShow,main: main};
};
