...
Elm.Page.SignalFoldp.make = function (_elm) {
   ...
   $Signal$Extra = Elm.Signal.Extra.make(_elm);
   var _op = {};
   var clicksCounterNote = $Component$Note.signalNote("foldp (\\_ n -> n + 1) 0 Mouse.clicks");
...
Elm.SignalFoldp = Elm.SignalFoldp || {};
Elm.SignalFoldp.make = function (_elm) {
   "use strict";
   _elm.SignalFoldp = _elm.SignalFoldp || {};
   if (_elm.SignalFoldp.values) return _elm.SignalFoldp.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var containerShow = function (element) {    return A4($Graphics$Element.container,1200,400,$Graphics$Element.middle,element);};
   var main = A2($Signal.map,containerShow,$Page$SignalFoldp.view);
   return _elm.SignalFoldp.values = {_op: _op,containerShow: containerShow,main: main};
};
