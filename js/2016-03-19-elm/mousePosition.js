...
Elm.MousePosition = Elm.MousePosition || {};
Elm.MousePosition.make = function (_elm) {
   "use strict";
   _elm.MousePosition = _elm.MousePosition || {};
   if (_elm.MousePosition.values) return _elm.MousePosition.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   var _op = {};
   var containerShow = function (signal) {    return A4($Graphics$Element.container,1000,300,$Graphics$Element.middle,$Graphics$Element.show(signal));};
   var main = A2($Signal.map,containerShow,$Mouse.position);
   return _elm.MousePosition.values = {_op: _op,containerShow: containerShow,main: main};
};
