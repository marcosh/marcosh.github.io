...
Elm.Page.SignalMap.make = function (_elm) {
   ...
   var keyboardCharNote = $Component$Note.signalNote("Signal.map Char.fromCode");
   var view = A2($Signal$Extra.mapMany,
   $Graphics$Element.flow($Graphics$Element.down),
...
Elm.SignalMap = Elm.SignalMap || {};
Elm.SignalMap.make = function (_elm) {
   "use strict";
   _elm.SignalMap = _elm.SignalMap || {};
   if (_elm.SignalMap.values) return _elm.SignalMap.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   var main = A2($Signal.map,containerShow,$Page$SignalMap.view);
   return _elm.SignalMap.values = {_op: _op,containerShow: containerShow,main: main};
};
