...
Elm.Talk.make = function (_elm) {
   ...
   var view = F2(function (address,talk) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.a,
                      _U.list([$Html$Attributes.href(talk.uri),$Html$Attributes.$class("title"),$Html$Attributes.target("_blank")]),
                      _U.list([$Html.text(talk.title)]))
                      ,$Html.text(" by ")
...
Elm.TalkMain = Elm.TalkMain || {};
Elm.TalkMain.make = function (_elm) {
   "use strict";
   _elm.TalkMain = _elm.TalkMain || {};
   if (_elm.TalkMain.values) return _elm.TalkMain.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var main = $StartApp$Simple.start({model: A6($Talk.Talk,
                                     ...
                                     "",
                                     "uri",
                                     _U.list(["Marco Perone"]))
                                     ,update: $Talk.update
                                     ,view: $Talk.view});
   return _elm.TalkMain.values = {_op: _op,main: main};
};
