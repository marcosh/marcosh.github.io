...
Before going into inspecting the various kinds of optics, let's try to see if we can already derive some properties of optics just by looking at their graphical representation.
